...
public class Utilisateur {
	...
	public Utilisateur(int idUtilisateur, String nom, String prenom, String email, String adresse, String tel,
	...
	public String toString() {
		return "Utilisateur [idUtilisateur=" + idUtilisateur + ", nom=" + nom + ", prenom=" + prenom + ", email="
				+ email + ", adresse=" + adresse + ", tel=" + tel + ", login=" + login + ", password=" + password
